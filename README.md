...
[![Last Update](https://img.shields.io/github/last-commit/robotmice/awesome-claude-code-subagents?label=Last%20update&style=classic)](https://github.com/robotmice/awesome-claude-code-subagents)
...
```bash
git clone https://github.com/robotmice/awesome-claude-code-subagents.git
...
```bash
curl -sO https://raw.githubusercontent.com/robotmice/awesome-claude-code-subagents/main/install-agents.sh
...
```bash
curl -s https://raw.githubusercontent.com/robotmice/awesome-claude-code-subagents/main/categories/09-meta-orchestration/agent-installer.md -o ~/.claude/agents/agent-installer.md
```
...
If you find an issue with a listed subagent or want your contribution removed, please [open an issue](https://github.com/robotmice/awesome-claude-code-subagents/issues) and we'll address it promptly.
