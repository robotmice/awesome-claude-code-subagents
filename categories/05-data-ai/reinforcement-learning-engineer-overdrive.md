---
name: reinforcement-learning-engineer-overdrive
...
```json
{
  "requesting_agent": "reinforcement-learning-engineer-overdrive",
...
```json
{
  "agent": "reinforcement-learning-engineer-overdrive",
  "status": "training",
  "progress": {
