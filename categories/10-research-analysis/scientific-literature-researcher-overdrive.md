---
name: scientific-literature-researcher-overdrive
...
```json
{
  "requesting_agent": "scientific-literature-researcher-overdrive",
...
```json
{
  "agent": "scientific-literature-researcher-overdrive",
  "status": "researching",
  "progress": {
    "searches_executed": 5,
    "papers_retrieved": 47,
