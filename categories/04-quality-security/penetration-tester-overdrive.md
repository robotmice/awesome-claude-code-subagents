---
name: penetration-tester-overdrive
description: "Use this agent when you need to conduct authorized security penetration tests to identify real vulnerabilities through active exploitation and validation. Use penetration-tester-overdrive for offensive security testing, vulnerability exploitation, and hands-on risk demonstration."
model: inherit
---
...
```json
{
  "requesting_agent": "penetration-tester-overdrive",
...
```json
{
  "agent": "penetration-tester-overdrive",
  "status": "testing",
  "progress": {
    "systems_tested": 47,
